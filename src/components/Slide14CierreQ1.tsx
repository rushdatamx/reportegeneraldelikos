...
const hallazgos = [
  ...
  { tipo: "positivo", texto: "Exportacion +3.8% ($29.4M) — 43.7% del total, 5 clientes export nuevos" },
  { tipo: "alerta", texto: "H1 baja -10.9% vs 2025, explicado por Mar-Abr 25 atipicos (ALSUPER $15.2M)" },
...
const acciones = [
  ...
  "Diversificar base de clientes nacionales — La Molienda ya es cliente #1 (32.2%)",
        ...
        <div className="w-[480px] flex flex-col gap-3">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-3 text-center">
              ...
              <p className="text-[#F7B500] text-xl font-bold">$67.2M</p>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-3 text-center">
              <p className="text-gray-400 text-[9px]">Productos activos</p>
              <p className="text-gray-800 text-xl font-bold">155</p>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-3 text-center">
